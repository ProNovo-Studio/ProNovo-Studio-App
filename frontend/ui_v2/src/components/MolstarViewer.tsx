  ...
  useEffect(() => {
    const initViewer = async () => {
      ...
      try {
        ...
        console.log(
          "[Molstar] initViewer: containerRef set?",
        ...
        pluginInstance.behaviors.interaction.click.subscribe((e: any) => {
          ...
          try {
            ...
            if (StructureElement.Loci.is(loci) && loci.elements.length > 0) {
              ...
              const insCode =
                StructureProperties.residue.pdbx_PDB_ins_code(loc) || null;
              const labelAsymId =
                StructureProperties.chain.label_asym_id(loc) || null;
              const authAsymId =
                StructureProperties.chain.auth_asym_id(loc) || null;
        ...
        <div className="absolute inset-0 bg-gray-900 flex items-center justify-center">
          <div className="text-white text-center">
            <div className="text-red-400 mb-2">
              Failed to initialize Molstar viewer
            </div>
