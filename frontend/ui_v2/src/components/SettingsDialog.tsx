...
export const SettingsDialog: React.FC<SettingsDialogProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "editor" | "interface" | "chat-history" | "advanced"
  >("editor");
  ...
  const handleReset = () => {
    if (
      confirm("Reset all settings to default values? This cannot be undone.")
    ) {
      resetSettings();
      setLocalSettings(settings);
      setHasChanges(false);
              ...
              {activeTab === "editor" && (
                <div className="space-y-1">
                  ...
                  <Switch
                    ...
                    onChange={(checked) =>
                      handleSettingChange("codeEditor.enabled", checked)
                    }
                  ...
                  <div className="border-t border-gray-200 pt-1">
                    <Switch
                      ...
                      onChange={(checked) =>
                        handleSettingChange("codeEditor.autoExecution", checked)
                      }
                  ...
                  {localSettings.codeEditor.enabled && (
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      <div className="text-gray-500 text-xs mb-3">
                        Code template shown when the editor first loads
                      </div>
                      <textarea
                ...
                <div className="space-y-1">
                  ...
                  <div className="border-t border-gray-200 pt-1">
                    <Switch
                      ...
                      onChange={(checked) =>
                        handleSettingChange("ui.showQuickPrompts", checked)
                      }
                ...
                <div className="space-y-1">
                      ...
                      <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <div>
                          ...
                          <div className="text-blue-700 text-xs">
                            Download all chat history as JSON backup
                          </div>
                        </div>
                        <button
                          onClick={() => {
                            ...
                            a.href = url;
                            a.download = `novoprotein-chat-backup-${
                      ...
                      <div className="flex items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <div>
                          ...
                          <div className="text-yellow-700 text-xs">
                            Remove sessions older than 30 days (starred sessions
                            are kept)
                          </div>
                        </div>
                        <button
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <div className="text-xs text-gray-500 italic">
                      Automatic cleanup of old sessions will be available in a
                      future update. You can manually cleanup old sessions using
                      the button above.
                    </div>
                  </div>
                </div>
              ...
              {activeTab === "advanced" && (
                <div className="space-y-1">
                  ...
                  <Switch
                    ...
                    onChange={(checked) =>
                      handleSettingChange("performance.debugMode", checked)
                    }
                    label="Debug Mode"
